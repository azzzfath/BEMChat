      ...
      <div class="relative">
        ...
        <section id="features" class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-cyan-900 to-sky-900">
          ...
          <div class="py-8 px-4 mx-auto max-w-screen-xl items-center  justify-center sm:py-20 lg:px-8">
              ...
              <div class="space-y-8 text-center md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 md:space-y-0">

                  <div class="flex flex-col items-center text-center bg-white/10 backdrop-blur-xl py-10 pb-14 px-4 rounded-md">
            ...
            <footer class="w-screen">
                ...
                <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                      <h1 class="text-white text-2xl font-bold">BEM Chat!</h1>
