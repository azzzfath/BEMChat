      ...
      {isOpen && (
        <div className="md:hidden bg-white/20 backdrop-blur-xl rounded-b-3xl px-6 py-4 text-white">
          <ul className="space-y-4 font-medium text-md">
            <li><a href="#about" className="block hover:text-secondary">About</a></li>
            <li><a href="#features" className="block hover:text-secondary">Features</a></li>
            <li><a href="#contact" className="block hover:text-secondary">Contact</a></li>
            <li>
              <button
                onClick={() => window.location.href = "/messages"}
